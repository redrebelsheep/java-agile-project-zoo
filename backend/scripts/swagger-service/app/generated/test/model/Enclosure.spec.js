...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Enclosure', function() {
      beforeEach(function() {
        instance = new OpenApiDefinition.Enclosure();
      });

      it('should create an instance of Enclosure', function() {
        // TODO: update the code to test Enclosure
        expect(instance).to.be.a(OpenApiDefinition.Enclosure);
      });
